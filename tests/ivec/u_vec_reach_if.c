/***************************************************************************************************
 * Test: u_vec_reach_if (reverse iteration with condition)
 *
 * Coverage:
 * - Reverse iterate with condition on empty vector
 * - Reverse iterate with condition on single element
 * - Reverse iterate with condition filtering elements
 * - Reverse iterate with complex condition
 **************************************************************************************************/
...
test() {
  ...
  /* int type: reverse filter range */
  {
    ...
    i32_t count = 0;
    u_vec_reach_if (v, it, it >= 100 && it < 200) {
  ...
  /* int type: reverse complex condition */
  {
    ...
    i32_t count = 0;
    u_vec_reach_if (v, it, (it % 3 == 0) && (it % 5 == 0)) {
      mut_true(it % 15 == 0);
      count++;
    }
    mut_eq(N / 15, count);
  ...
  /* int type: reverse filter first N elements */
  {
    ...
    i32_t count = 0;
    u_vec_reach_if (v, it, it < N_SMALL) {
      mut_true(it < N_SMALL);
      count++;
    }
  ...
  /* int type: reverse filter last N elements */
  {
    ...
    i32_t count = 0;
    u_vec_reach_if (v, it, it >= N - N_SMALL) {
