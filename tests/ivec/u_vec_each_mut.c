 ...
 *
 * Coverage:
 * - Iterate empty vector with mutable pointer
 * - Iterate single element with mutable pointer
 * - Iterate full vector with mutable pointer
...
test() {
  ...
  /* str_t type: modify all elements */
  {
