/***************************************************************************************************
 * Test: u_vec_each_if_ref
 *
 * Coverage:
 * - Iterate with condition on empty vector (pointer)
 * - Iterate with condition on single element (pointer)
 * - Iterate with condition filtering elements (pointer)
 * - Iterate with complex condition (pointer)
 **************************************************************************************************/
...
test() {
  ...
  /* int type: filter range */
  {
    ...
    i32_t count = 0;
    u_vec_each_if_ref (v, it, *it >= 100 && *it < 200) {
  ...
  /* int type: complex condition */
  {
    ...
    i32_t count = 0;
    u_vec_each_if_ref (v, it, (*it % 3 == 0) && (*it % 5 == 0)) {
      mut_true(*it % 15 == 0);
      count++;
    }
    mut_eq(N / 15, count);
  ...
  /* int type: filter first N elements */
  {
    ...
    i32_t count = 0;
    u_vec_each_if_ref (v, it, *it < N_SMALL) {
      mut_true(*it < N_SMALL);
      count++;
    }
  ...
  /* int type: filter last N elements */
  {
    ...
    i32_t count = 0;
    u_vec_each_if_ref (v, it, *it >= N - N_SMALL) {
  ...
  /* int type: no elements match condition */
  {
    ...
    bool iterated = false;
    u_vec_each_if_ref (v, it, *it > N * 10) {
      iterated = true;
    }
    mut_false(iterated);
  }
