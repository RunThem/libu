...
#define buf_data(buf) __buf_data(buf)
...
#define buf_slen(buf, len) __buf_slen(buf, len)
...
#define buf_push(buf, mem, arg...) __buf_push(buf, mem, va_0th(sizeof(*(mem)), arg))
