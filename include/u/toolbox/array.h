...
int u_array_set_long_long(u_array_t* da, size_t idx, long long v, long long* pold);

/** \brief  Setter for the \c unsigned \c long \c long type */
int u_array_set_u_long_long(u_array_t* da,
                            size_t idx,
...
int u_array_set_u_intmax(u_array_t* da, size_t idx, uintmax_t v, uintmax_t* pold);
...
int u_array_set_long_double(u_array_t* da, size_t idx, long double v, long double* pold);
...
int u_array_set_float_complex(u_array_t* da, size_t idx, float _Complex v, float _Complex* pold);
...
int u_array_set_double_complex(u_array_t* da, size_t idx, double _Complex v, double _Complex* pold);
...
int u_array_set_long_double_complex(u_array_t* da,
                                    size_t idx,
                                    long double _Complex v,
                                    long double _Complex* pold);

/** \brief  Getter for the \c long \c double \c _Complex type */
int u_array_get_long_double_complex(u_array_t* da, size_t idx, long double _Complex* pv);
#endif /* HAVE_LONG_DOUBLE__COMPLEX */
