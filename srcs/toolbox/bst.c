...
static int u_bst_node_new(u_bst_t* bst, const void* key, const void* val, u_bst_node_t** pnode);
static void u_bst_node_free(u_bst_t* bst, u_bst_node_t* node);
static void u_bst_node_do_free(u_bst_t* bst, u_bst_node_t* node);
static int u_bst_assign(void** pdst, const void* src, u_bst_type_t t, size_t sz);
static u_bst_node_t*
    u_bst_node_search(u_bst_node_t* node, const void* key, int (*cmp)(const void*, const void*));
static void u_bst_node_foreach(u_bst_node_t* node, void (*cb)(u_bst_node_t*, void*), void* cb_args);
static u_bst_node_t*
    u_bst_node_push_top(u_bst_t* bst, u_bst_node_t* node, const void* key, const void* val);
static u_bst_node_t* u_bst_node_push_bottom(u_bst_t* bst, const void* key, const void* val);
static u_bst_node_t*
    u_bst_node_push_rand(u_bst_t* bst, u_bst_node_t* node, const void* key, const void* val);
static u_bst_node_t*
    u_bst_node_push(u_bst_t* bst, u_bst_node_t* node, const void* key, const void* val);
...
static u_bst_node_t*
    u_bst_node_delete(u_bst_t* bst, u_bst_node_t* node, const void* key, int* pfound);
...
static void
    u_bst_node_foreach(u_bst_node_t* node, void (*cb)(u_bst_node_t*, void*), void* cb_args) {
  if (node == NULL) {
    return;
  }
