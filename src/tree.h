...
#define U_TREE_DEFINE(prefix, alloc, free, ...)                                                    \
    ...
    if (p == NULL) {                                                                               \
      ...
      if (p->l == o) {                                                                             \
        ...
        p->r = n;                                                                                  \
                                                                                                   ...
                                                                                                   \
  static inline prefix##node_t __##prefix##tree_rotate_left(prefix##tree_t T, prefix##node_t n) {  \
    ...
    return r;                                                                                      \
                                                                                                   ...
                                                                                                   \
  static inline prefix##node_t __##prefix##tree_rotate_right(prefix##tree_t T, prefix##node_t n) { \
  ...
  static bool __##prefix##tree_node_is_leaf(prefix##node_t node) {                                 \
    return node->l == NULL && node->r == NULL;                                                     \
                                                                                                   ...
                                                                                                   \
  static void __##prefix##tree_node_dump(prefix##node_t node, prefix##tree_node_dump_fn dump_fn) { \
